...
import com.github.jrgonzalezg.openlibrary.UnitTests
import io.kotlintest.TestCaseContext
import okhttp3.mockwebserver.MockWebServer

abstract class NetworkUnitTests : UnitTests() {
  lateinit var networkComponent: TestNetworkComponent
  lateinit var mockWebServer: MockWebServer

  val networkInterceptor: (TestCaseContext, () -> Unit) -> Unit = { context, testCase ->
    networkComponent = DaggerTestNetworkComponent.builder().testNetworkModule(
        TestNetworkModule()).build()
    mockWebServer = networkComponent.mockWebServer()
